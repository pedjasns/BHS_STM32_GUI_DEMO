...
#if (LCD_CONTROLLER == 1375) | (LCD_CONTROLLER == 13705) | (LCD_CONTROLLER == 1386) | (LCD_CONTROLLER == 13806) |(LCD_CONTROLLER == -1)
...
#if GUIDEMO_LARGE
   GUI_DispStringAt("Himax 8346\n", 10, 65);
#else
   GUI_DispStringHCenterAt("Himax 8346\n", LCD_XSIZE >> 1, LCD_YSIZE / 14);
#endif
   _Show("On chip GRAM", "1380 kb");
   _Show("Max. colors", "262144 (up to 18 bpp)");
   _Show("Display types", "Mono / color / TFT");
   _Show("LUT", "256 index colors");
#endif
   GUIDEMO_Delay(2500);
