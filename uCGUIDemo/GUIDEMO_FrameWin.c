...
{
   "English", "Deutsch", "Français", "Espa\xf1ol",
   /* "Español" -> "Espa\xf1ol" to avoid problems with NC308 */
   "Italiano", NULL
};
...
void GUIDEMO_DemoFrameWin(void)
{
   ...
   hListBox = LISTBOX_CreateAsChild(_asLang, WM_GetClientWindow(hFrame), 0, 0,
               0, 0,
               WM_CF_SHOW |
               WM_SF_ANCHOR_LEFT |
               WM_SF_ANCHOR_TOP |
