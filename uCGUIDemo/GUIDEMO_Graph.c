...
static void _Draw(void* p)
{
   ...
   GUI_ClearRect(19, (LCD_YSIZE - 20) - YSIZE, (LCD_XSIZE - 2),
      (LCD_YSIZE - 21));
...
static void _Draw2(void* p)
{
   ...
   GUI_DrawGraph(pParam->aY + 15, (LCD_XSIZE - 20), 19,
      (LCD_YSIZE - 20) - YSIZE);
}
...
static void _Label(void)
{
   ...
   GUI_DrawRect(18, (LCD_YSIZE - 21) - YSIZE, (LCD_XSIZE - 1),
      (LCD_YSIZE - 20));
...
static void _DemoRandomGraph(void)
{
   ...
   GUI_RECT Rect =
   {
      19, (LCD_YSIZE - 20) - YSIZE, (LCD_XSIZE - 2), (LCD_YSIZE - 21)
   };
